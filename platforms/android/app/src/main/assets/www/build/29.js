...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__inspection__ = __webpack_require__(1449);
...
var InspectionPageModule = /** @class */ (function () {
    ...
    InspectionPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__inspection__["a" /* InspectionPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__inspection__["a" /* InspectionPage */]),
            ],
        })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_constant_constant__ = __webpack_require__(5);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var InspectionPage = /** @class */ (function () {
    function InspectionPage(navCtrl, db, actionSheetController, camera, alertCtrl, mediaCapture, diagnostic, androidPermissions, dom, serve, loadingCtrl, navParams, constant) {
    ...
    InspectionPage.prototype.showAlert = function (text) {
    ...
    InspectionPage.prototype.isCameraAvailable = function () {
        var _this = this;
    ...
    InspectionPage.prototype.captureMedia = function () {
        var _this = this;
        if (this.videoId) {
    ...
    InspectionPage.prototype.showLimit = function () {
    ...
    InspectionPage.prototype.captureImageVideo = function () {
        var _this = this;
        var actionsheet = this.actionSheetController.create({
    ...
    InspectionPage.prototype.takePhoto = function () {
        var _this = this;
    ...
    InspectionPage.prototype.getImage = function () {
        var _this = this;
        var options = {
            quality: 70,
            destinationType: this.camera.DestinationType.DATA_URL,
    ...
    InspectionPage.prototype.fileChange = function (img) {
        this.image_data.push({ "image": img });
        console.log(this.image_data);
        this.image = '';
    };
    InspectionPage.prototype.remove_image = function (i) {
        this.image_data.splice(i, 1);
    };
    InspectionPage.prototype.get_segment = function () {
        var _this = this;
        this.db.addData({}, "AppCustomerNetwork/segmentList")
            .then(function (resp) {
            if (resp['statusCode'] == 200) {
                _this.segment_list = resp['data'];
                console.log(_this.segment_list);
            }
            else {
    ...
    InspectionPage.prototype.get_sub_segmentDetail = function (category, sub_category) {
        var _this = this;
        ...
        this.db.addData({ 'filter': this.filter }, "AppCustomerNetwork/segmentItems")
            ...
            if (resp['statusCode'] == 200) {
                ...
                console.log(_this.segment_detail);
            }
            else {
                _this.db.errorToast(resp['statusMsg']);
            }
    ...
    InspectionPage.prototype.segmentItemsDetail = function (id) {
        console.log(id);
        if (id) {
    ...
    InspectionPage.prototype.showSuccess = function (text) {
        var alert = this.alertCtrl.create({
            title: 'Success!',
            subTitle: text,
            buttons: ['OK']
    ...
    InspectionPage.prototype.onUploadChange = function (evt) {
        var _this = this;
        var actionsheet = this.actionSheetController.create({
            title: this.upl_file,
            cssClass: 'cs-actionsheet',
    ...
    InspectionPage.prototype.getDocImage = function () {
        var _this = this;
        var options = {
            quality: 75,
            destinationType: this.camera.DestinationType.DATA_URL,
    ...
    InspectionPage.prototype.takeDocPhoto = function () {
        var _this = this;
        var options = {
            quality: 75,
            destinationType: this.camera.DestinationType.DATA_URL,
    ...
    InspectionPage.prototype.onUploadBackChange = function (evt) {
        var _this = this;
        var actionsheet = this.actionSheetController.create({
            title: this.upl_file,
            cssClass: 'cs-actionsheet',
    ...
    InspectionPage.prototype.backDocPhoto = function () {
        var _this = this;
        var options = {
            quality: 75,
            destinationType: this.camera.DestinationType.DATA_URL,
    ...
    InspectionPage.prototype.backDocImage = function () {
        var _this = this;
        var options = {
            quality: 75,
            destinationType: this.camera.DestinationType.DATA_URL,
    ...
    InspectionPage.prototype.saveInspection = function () {
        var _this = this;
        ...
        this.serve.addData({ "data": this.formData }, 'AppServiceTask/complaintInspection').then(function (result) {
            if (result['statusCode'] == 200) {
                ...
                _this.navCtrl.popTo(__WEBPACK_IMPORTED_MODULE_8__complaints_complaint_detail_complaint_detail__["a" /* ComplaintDetailPage */], { id: _this.id });
            }
            else {
    ...
    InspectionPage.prototype.presentLoading = function () {
    ...
    InspectionPage.prototype.calculateWarrantyEnd = function () {
