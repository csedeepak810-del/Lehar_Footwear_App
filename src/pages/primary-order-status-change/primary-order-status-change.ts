...
/**
 * Generated class for the PrimaryOrderStatusChangePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-primary-order-status-change',
  templateUrl: 'primary-order-status-change.html',
})
export class PrimaryOrderStatusChangePage {
  ...
  submit() {
    ...
    this.service.addData({'data':this.data}, 'appOrder/primaryOrderStatusChange').then((result) => {
